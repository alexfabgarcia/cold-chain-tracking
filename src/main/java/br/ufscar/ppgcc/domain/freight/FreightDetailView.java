...
import br.ufscar.ppgcc.domain.geolocation.GeolocationService;
...
public class FreightDetailView extends VerticalLayout {
    ...
    public FreightDetailView(GeolocationService geolocationService) {
